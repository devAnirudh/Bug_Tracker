...
body {
	background-image:
		url("img/robotic_automation1.jpg");
	...
	<form action="Login" method="post">
		<div class="container_login" id="container_login"
			...
			<label><b> Username </b></label> <input type="text"
				placeholder="Username" name="uname" id="uname" onblur = "trim_input(this.id)" required> <label>
				<b> Password </b>
			</label> <input type="password" placeholder="Password" name="pword"
				id="pword" onblur = "trim_input(this.id)" required> <input type="submit"
				onclick="validateInput()" id="login" value="Login">
